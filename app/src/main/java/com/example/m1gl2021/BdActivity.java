    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(b){
                    Toast.makeText(BdActivity.this, "Utilisateur créé", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(BdActivity.this, "Utilisateur non créé", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(b){
                    Toast.makeText(BdActivity.this, "Utilisateur modifé", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(BdActivity.this, "Utilisateur non modifé", Toast.LENGTH_SHORT).show();
                }
            }
        });
